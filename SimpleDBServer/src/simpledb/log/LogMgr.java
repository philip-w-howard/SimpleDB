...
public class LogMgr implements Iterable<BasicLogRecord> {
    ...
    * which will be returned in forward order starting with the specified block.
    * @see java.lang.Iterable#iterator()
    * @param blkNum The starting block for the iterator
    */
   public synchronized Iterator<BasicLogRecord> iterator(Block blk) {
      flush();
      return new LogFwdIterator(blk);
   }
